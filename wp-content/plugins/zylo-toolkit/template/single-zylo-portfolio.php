...
<section class="service-details-area">
    ...
    if( have_posts() ):
        while( have_posts() ): the_post();
            $project_details_img_full = get_post_meta(get_the_ID(),'portfolio_details_img',true);
                    ...
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="service-widget">
                                <?php 
                                if( !empty( $project_details_img_full ) ): ?>
                                    <div class="thumb-big wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.3s">
                                        <img src="<?php echo esc_url( $project_details_img_full ); ?>" alt="img">
                                    </div>
                                <?php 
                                endif; ?>
