                            ...
                            <div class="service-widget">
                                ...
                                if( !empty($service_details_image) ): ?>
                                    <div class="thumb-big wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.3s">
                                        <img src="<?php echo esc_url($service_details_image); ?>" alt="img">
                                    </div>
                                <?php 
                                endif; ?>
                                ...
                                <div class="row gy-2">
                                    <div class="col-sm-6">
                                        <div class="details-thumb wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.3s">
                                            <img src="<?php echo esc_html( $service_single_left_thumb_img ); ?>" alt="img">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="details-thumb wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.3s">
                                            <img src="<?php echo esc_html( $service_single_right_thumb_img ); ?>" alt="img">
                                        </div>
                                    </div>
                                </div>
                                <?php echo wp_kses_post( $tiny_content ); ?>
