...
class LuxelifeServicePost extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        // Single Card Section Padding
        $this->start_controls_section(
            'single_card_padding_tab',
                [
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => ['px', '%', 'em'],
                    'selectors' => [
                        '{{WRAPPER}} .service-style-2 .singleitem' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                'single_card_border_style',
                [
                    'label' => esc_html__( 'Border Style', 'zylo-elementor' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'solid',
                    'options' => [
                        'none'   => esc_html__( 'None', 'zylo-elementor' ),
                        'solid'  => esc_html__( 'Solid', 'zylo-elementor' ),
                        'dashed' => esc_html__( 'Dashed', 'zylo-elementor' ),
                        'dotted' => esc_html__( 'Dotted', 'zylo-elementor' ),
                        'double' => esc_html__( 'Double', 'zylo-elementor' ),
                    ],
                    'selectors' => [
                        '{{WRAPPER}} .service-style-2 .singleitem' => 'border-style: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Border Color', 'zylo-elementor' ),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .service-style-2 .singleitem' => 'border-color: {{VALUE}};',
                    ],
                ]
            );

            $this->add_responsive_control(
                'single_card_border_width',
                [
                    'label' => esc_html__( 'Border Width', 'zylo-elementor' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px' ],
                    'selectors' => [
                        '{{WRAPPER}} .service-style-2 .singleitem' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .service-style-2 .singleitem.active .content .title' => 'color: {{VALUE}};',
                    ],
                    'condition' => [
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .service-style-2 .singleitem .content .title' => 'width: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
